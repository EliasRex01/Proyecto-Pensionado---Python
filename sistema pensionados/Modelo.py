#!/usr/bin/env python3
'''
Clase modelo que tiene la logica de definicion de las clases que representan
...
class PostScraping:
    ...
    def mostrar_datos_honorifico(self, data):
        print("")
        print("Datos Del Pensionado Honorifico:")
        print(f"CI: {data.ci}")
        ...
        print(f"Monto de Pension: {data.monto_pension}")
        print("")
